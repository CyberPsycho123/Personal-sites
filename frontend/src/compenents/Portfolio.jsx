...
const Portfolio = ({ certificates, projects }) => {
  ...
  const role_description = [
    { name: 'BRITTO BINOY', resume: "", github: "#", linked: "https://www.linkedin.com/in/britto-binoy-769782338/", role: "Aspiring CyberSecurity Engineer", roledesc: "Specializing in Cryptography and Blockchain technologes protection and security", email: "brittobinoy507@gmail.com", phone: "8891489037", location: "Nadathara,Thrissur,Kerala", about: "I'm Britto Binoy who is a Cyber Security student with a strong interest in blockchain technology and cryptography.I'm focused on building a solid foundation in securing digital systems, understanding cryptographic principles, and exploring decentralized technologies. With a proactive learning mindset,I aims to develop practical skills in identifying vulnerabilities, enhancing system security, and contributing to secure, transparent, and resilient digital infrastructures.", color: 'blue' },
    ...
    { name: 'ADHIL KB', resume: "", github: "#", linked: "#", role: "Aspiring CyberSecurity Engineer", roledesc: "Specialising in penetration testing to identify security weaknesses and improve system defenses", email: "mrcrnts07@gmail.com", phone: "6282888270", location: " chalingad, thrissur,Kerala", about: "I am a passionate Cyber Security student currently pursuing my B.Tech in Cyber Security at jyothi Engineering College. With a strong academic foundation from my Plus Two qualification, I have developed a deep interest in digital security, ethical hacking, and protecting systems from cyber threats.I am driven by curiosity and continuous learning, always working to improve my technical skills in areas such as network security, cyber defense, and secure computing. My goal is to grow into a skilled cyber security professional who contributes to building safe, reliable, and secure digital environments for individuals and organizations.I believe cyber security is not just a career, but a responsibility to protect the digital world", color: 'brown' },
    { name: 'VAISHNAV MANOJ', resume: "", github: "#", linked: "https://www.linkedin.com/in/vaishnav-manoj-6bb781338/", role: "Aspiring CyberSecurity Engineer", roledesc: "Specialising in penetration testing to identify security weaknesses and improve system defenses", email: "vaishnavjecc@gmail.com", phone: "7736363778", location: " Kunnamkulam ,Thrissur,Kerala", about: "I have represented my school at the interschool level in basketball and kho-kho in Abu Dhabi and have participated in multiple sports meets across the UAE, Also i am currently developing skills in backend development.", color: 'orange' },
